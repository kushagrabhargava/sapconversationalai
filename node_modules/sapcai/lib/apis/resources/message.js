...
var Message = function Message(body, oAuthToken, sapcaiToken) {
  var _this = this;
  ...
  this.reply = function () {
    ...
    _this._messageStack = [];
    return agent('POST', _constants2.default.MESSAGE_ENDPOINT.replace(':conversation_id', _this.conversationId)).set('Authorization', 'Bearer ' + _this.oAuthToken).set('X-Token', 'Token ' + this.sapcaiToken).send({ messages: messages });
  ...
  this.sapcaiToken = "eb942fbf1df214b7e33053f36248b23a";
  this._messageStack = [];
};
